  ...
  return (
    <div className="h-[10vh] py-4 px-8 flex items-center gap-4">
      ...
      <div className="flex items-center gap-4">
        <button onClick={createQuiz} disabled={creating} className="relative border hover:border-indigo-600 duration-500 group cursor-pointer text-indigo-50  overflow-hidden h-11 w-40 rounded-md bg-indigo-800 p-2 flex justify-center items-center font-extrabold disabled:opacity-45">
          ...
          <p className="z-10">{creating ? <IconLoader2 className="animate-spin" /> : "Crear"}</p>
        </button>
